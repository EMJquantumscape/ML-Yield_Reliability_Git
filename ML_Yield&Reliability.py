...
df_master.loc[
    df_master["samplename"].str.contains('PS00'),
    "cell_tier_group",
] = "Tier 1"

df_master.loc[
    df_master["samplename"].str.contains('PS01'),
    "cell_tier_group",
] = "Tier 2"

df_master.loc[
    df_master["samplename"].str.contains('PS02'),
    "cell_tier_group",
] = "Tier 3"
...
# Filter out Tier 3 cells
data = data[data.cell_tier_group.str.contains('Tier 1|Tier 2')]
...
df_screening = df_screening[['samplename','cell_tier_group', 'cell_build_date', 'Tool', 'Channel', 'ML Screen', 'Reliability Result', '1C Count', 'Fast-Charge Count', 'C/3 Count', 'Total Reliability Cycles','Last Cycle', 'recipe_name']]
...
df_screening = df_screening.sort_values(by=['cell_build_date', 'samplename'], ascending=[True, True])

# Step 6: Display the updated dataframe
df_screening = df_updated
